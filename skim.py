...
outputFile = ROOT.TFile.Open('eos/cms/store/group/phys_egamma/PFClusteRegressionTrees/afterDebug_16june/pfClustersTree_FULL_%s_PT3_skim.root' % sys.argv[1], 'RECREATE')
