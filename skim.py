...
##pfClustersTree_noPU_FULL_EB_
inputFile = ROOT.TFile.Open('/eos/cms/store/group/phys_egamma/PFClusterCalibration/150_V1_2018UL/FlatTrees/v1//pfClustersTree_noPU_FULL_%s_PT3.root' % sys.argv[1])
#inputFile = ROOT.TFile.Open('/eos/cms/store/group/phys_egamma/PFClusterCalibration/150_V0_2017/pfClustersTree_FULL_%s_PT3.root' % sys.argv[1])
...
outputFile = ROOT.TFile.Open('/eos/cms/store/group/phys_egamma/PFClusterCalibration/150_V1_2018UL/FlatTrees/v1//pfClustersTree_noPU_FULL_%s_PT3_skim.root' % sys.argv[1], 'RECREATE')
#outputFile = ROOT.TFile.Open('/eos/cms/store/group/phys_egamma/PFClusterCalibration/150_V0_2017/pfClustersTree_FULL_%s_PT3_skim.root' % sys.argv[1], 'RECREATE')
