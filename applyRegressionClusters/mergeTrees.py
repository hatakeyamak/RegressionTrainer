...
#outputFile = ROOT.TFile.Open(sys.argv[1]+"_withRegression_OLD.root", "RECREATE")
#inputFile1 = ROOT.TFile.Open(sys.argv[1]+"_testing_OLD.root")
#inputFile2 = ROOT.TFile.Open(sys.argv[1]+"_application_OLD.root")

outputFile = ROOT.TFile.Open(sys.argv[1]+"_withRegression.root", "RECREATE")
inputFile1 = ROOT.TFile.Open(sys.argv[1]+"_testing.root")
